...
void test_mydgemm_v22(int m,int n,int k,double alpha,double *A,double *B,double beta,double *C){
    mydgemm_cpu_v22(m,n,k,alpha,A,m,B,k,beta,C,m);
}
...
void test_kernel(int kernel_num,int m,int n,int k,double alpha,double *A,double *B,double beta,double *C){
    switch (kernel_num){
        ...
        case 22: test_mydgemm_v22(m,n,k,alpha,A,B,beta,C); break;
        default: break;
    }
}
